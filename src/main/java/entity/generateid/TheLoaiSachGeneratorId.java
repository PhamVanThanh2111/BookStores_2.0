...
public class TheLoaiSachGeneratorId implements IdentifierGenerator {
	@Override
	public Serializable generate(SharedSessionContractImplementor session, Object object) {
	    ...
	    try {
	        ...
	        Long count = (Long) entityManager.createQuery("select count(maTheLoaiSach) from TheLoaiSach")
	                                        .getSingleResult();
